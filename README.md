...
Deberán elegir una de las 3 opciones y desarrollar el trabajo de acuerdo a las pautas detalladas a continuación.
...
4. Forma de evaluación:
   ...
   2. Criterios de evaluación:
      ...
      4. TBC: ejecutar el caso de prueba dado por la materia.
   
---
A continuación se describen los problemas entre los que se deberá elegir:
  
## Sugeridor de personas que quizás conozcas
...
- Debe poder gestionar una cantidad grande de usuarios (+1000).
...
- Debe implementar un formato propio definido por el equipo. 
...
- El programa debe tardar un tiempo del orden de los segundos o minutos (<5).
...
Desarrollar un programa que permita gestionar, analizar y clasificar logs de acceso de un servidor web. El sistema deberá procesar archivos de log generados por un servidor web (por ejemplo, con formato similar a Apache o Nginx) y brindar información estadística y clasificada a partir de dichos registros. 
...
- El formato exacto del archivo de log deberá el defindo por ```Apache Combined Log```:
